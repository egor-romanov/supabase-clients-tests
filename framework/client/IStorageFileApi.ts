import { FileObject, FileOptions, SearchOptions } from '@supabase/storage-js'
import { FetchParameters } from '@supabase/storage-js/src/lib/fetch'

export interface IStorageFileApi {
    /**
